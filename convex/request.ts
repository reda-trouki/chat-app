...
export const create = mutation({
    ...
    handler: async (ctx, args) =>{
        ...
        if(args.email === identity.email ) throw new ConvexError("Cannot send request to your yourself");
        ...
        if(requestAlreadyReceived) throw new ConvexError("Request already sent ");
        ...
        if(
            ...
            friend1.some((friend) => friend.user1 === receiver._id)
